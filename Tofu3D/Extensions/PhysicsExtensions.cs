        ...
        switch (shape)
        {
            case CircleShape circleCollider:
                if ((distance = Vector2.Distance(circleCollider.Transform.WorldPosition.ToVector2(), point)) <
                    circleCollider.Radius) isIn = true;
            ...
            case BoxShape boxCollider:
                ...
                Vector2 start = boxPosition + boxCollider.Offset * boxCollider.Transform.LocalScale +
                                boxCollider.Size * boxCollider.Transform.Pivot;
                Vector2 end = boxPosition + boxCollider.Offset * boxCollider.Transform.LocalScale +
                              (boxCollider.Size + boxCollider.Size * boxCollider.Transform.Pivot) *
