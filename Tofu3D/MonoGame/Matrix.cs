...
public struct Matrix : IEquatable<Matrix>
{
    ...
    {
        Matrix matrix;
        CreateOrthographicOffCenter(viewingVolume.Left, viewingVolume.Right, viewingVolume.Bottom, viewingVolume.Top,
            zNearPlane, zFarPlane, out matrix);
        return matrix;
    }
    ...
    public static void Invert(ref Matrix matrix, out Matrix result)
    {
        ...
        float num27 = (float)(1.0 / (num1 * (double)num23 + num2 * (double)num24 + num3 * (double)num25 +
                                     num4 * (double)num26));
