...
{
    private Dictionary<char, int> _fontMappings = new()
    {
        { ' ', 0 },
        { '0', 16 },
        { '1', 17 },
    ...
    [ShowIf(nameof(IsGradient))]
    public Color GradientColor2 = Color.White;
    ...
    {
        if (BoxShape == null || Texture.Loaded == false || Text == null) return;
             ...
             symbolInLineIndex++)
        {
            ...
            if (_fontMappings.ContainsKey(ch)) glyphMappingIndex = _fontMappings[ch];
