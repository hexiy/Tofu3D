...
public class Transform : Component
{
	...
	{
		// if (ParentId != -1 && Tofu.I.SceneManager.CurrentScene.GetGameObject(ParentId) != null)
		// {
		// 	Tofu.I.SceneManager.CurrentScene.GetGameObject(ParentId).Transform.RemoveChild(GameObjectId);
		// }
