...
void main(void)
{
	...
	vec4 albedoColorLit = albedoColor * vec4(final_ambient.rgb, 1) + diffuse;
...
//	}
	...
	if (u_renderMode == 1) // albedo
	{
		fragColor = vec4(albedoColor.rgb, result.a);
	}
	if (u_renderMode == 2) // positions
	{
