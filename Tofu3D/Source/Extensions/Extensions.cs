...
public static class Extensions
{
    ...
    public static Color SetAlpha(ref this Color col, float a)
    {
        col = new Color(col.R, col.G, col.B, a);
        return col;
    }

    public static Color GetColorWithAlpha(this Color col, float a)
    {
        col = new Color(col.R, col.G, col.B, a);
        return col;
    }

    public static Color SetRGB(ref this Color col, Vector3 rgb)
    {
        col.SetRGB(rgb.X, rgb.Y, rgb.Z);
        return col;
    }

    public static Color GetColorWithRGB(this Color col, float r, float g, float b)
    {
        return col.SetRGB(r, g, b);
    }

    public static Color SetRGB(ref this Color col, float r, float g, float b)
    {
        col = new Color(r, g, b, col.A);
        return col;
    }

    public static Vector2 Set(ref this Vector2 vec, Vector2 vec2) => vec.Set(vec2.X, vec2.Y);

    public static Vector3 Set(ref this Vector3 vec, Vector3 vec2) => vec.Set(vec2.X, vec2.Y, vec2.Z);
    ...
    public static Vector4 ToVector4(this System.Numerics.Vector4 vector) =>
    ...
    public static Vector3 ToVector3XY(this Vector2 point, float z) => new Vector3(point.X, point.Y, z);
    public static Vector3 ToVector3XZ(this Vector2 point, float y) => new Vector3(point.X, y, point.Y);
